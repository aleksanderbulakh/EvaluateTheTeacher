...
namespace AvaluateTheTeacher1.CodeReview.Models
{
    public class VotingModel
    {
        ...
        public VotingList InfoForRaitingList(int? groupId)
        {
            ...
            var listS = thisGroup.TeachersSubjects.ToList();
            ...
            var query = from listTeacher in db.Teachers
                        ...
                        .Where(listTeachersSubj => (listS.Contains(listTeachersSubj) && listSubject.Id == listTeachersSubj.SubjectId && listTeacher.TeacherId == listTeachersSubj.TeacherId && listRaiting.TeacherId == listTeacher.TeacherId))
